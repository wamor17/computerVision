...
int main(int argc, char **argv){
	...
	cout<<"\n Please wait... \n";
//	SE OBTIENEN LAS CARACTERISTIAS DE LA IMAGEN
	inspectorWindow();
//	UMBRALIZO LA IMAGEN RESULTANTE DE LA HOMOGENEIDAD
	segmentacion();
...
//	ESTA ES LA FUNCION QUE AGREGUE PARA UMBRALIZAR LA IMAGEN DE CARACTERISTICA DE
//	LA HOMOGENEIDAD
//	** SOLO SE AGREGO ESTA FUNCION EN ESTE PROGRAMA
void segmentacion(){
//	UTILIZO UN UMBRAL DE 40 PARA DEJAR SOLO LA HOJA QUE ES LO QUE ME INTERESA
