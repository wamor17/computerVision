...
//	SE REALIZA LA EROSION VARIAS VECES PARA QUITAR LOS OBJETOS QUE NO NOS INTERESAN
	out = erosion(erosion(erosion(erosion(erosion(erosion(erosion(erosion(img, element(3)), element(3)), element(3)), element(3)), element(3)), element(3)), element(3)), element(3));
	plot(out);
